    ...
    <div className="min-h-screen relative">
      ...
      <div className="sticky top-20 z-40 px-4 sm:px-6 mb-6">
        <div className="max-w-6xl mx-auto">
          <Link href="/side-projects/guitar" className="inline-flex items-center gap-2 text-sm text-white/50 hover:text-white/80 transition-colors glass px-4 py-2 rounded-full">
