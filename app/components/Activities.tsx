export default function Activities() {
  return (
    <section id="activities" className="mb-10 animate-fade-in-up">
      ...
      <div className="bg-white dark:bg-gray-800/50 rounded-xl p-6 border border-gray-100 dark:border-gray-700/50 shadow-sm hover:shadow-md transition-shadow">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-1">
          <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Google Developer Student Club, CSU East Bay</h3>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
          <p className="text-blue-600 dark:text-blue-400 font-medium">Active Member</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">Fall 2023 – Present</p>
        </div>
