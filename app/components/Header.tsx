    ...
    <header className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 animate-gradient text-white p-10 sm:p-16 rounded-2xl">
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-3 text-sm">
          ...
          <a href="tel:+6577228927" className="inline-flex items-center gap-1.5 bg-white/10 backdrop-blur-sm px-3 py-1.5 rounded-full border border-white/20 hover:bg-white/20 transition-colors">
